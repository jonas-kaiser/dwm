...
enum { SchemeNorm, SchemeSel, SchemeWarn, SchemeUrgent, SchemeCol5 }; /* color schemes */
...
resizeclient(Client *c, int x, int y, int w, int h)
{
	...
	if (((nexttiled(c->mon->clients) == c && !nexttiled(c->next))
	    ...
	    /* fakefullscreen patch   && !c->isfullscreen   */) {
		c->w = wc.width += c->bw * 2;
...
updatesystray(void)
{
	...
	//FIXME this function breaks. TODO find out what it does and why it
	//                                 works without the alpha patch applied
